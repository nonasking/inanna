...
#ifndef INANNA_SWIFT_H
#define INANNA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Inanna",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Inanna10CallEngine")
@interface CallEngine : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVAudioPlayer;
@interface CallEngine (SWIFT_EXTENSION(Inanna)) <AVAudioPlayerDelegate>
